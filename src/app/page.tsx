...
import GuestTripForm from '@/components/home/GuestTripForm'
    ...
    <div className="min-h-screen bg-cream-50 flex flex-col selection:bg-amber-200">
      ...
      <main className="flex-1 flex flex-col lg:flex-row items-center justify-between px-6 md:px-12 py-10 md:py-20 max-w-7xl mx-auto w-full gap-12 lg:gap-16">
        ...
        <div className="flex-1 relative w-full max-w-md mx-auto lg:max-w-none mt-8 lg:mt-0">
          <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[120%] h-[120%] bg-amber-200/40 rounded-full blur-3xl -z-10 hidden md:block"></div>
          
          <div className="grid grid-cols-2 gap-3 md:gap-6 items-center">
            <div className="space-y-3 md:space-y-6 mt-6 lg:mt-12">
              <div className="relative group overflow-hidden rounded-2xl md:rounded-3xl shadow-xl aspect-[4/5] border-2 md:border-4 border-white bg-amber-100">
                <Image 
              ...
              <div className="relative group overflow-hidden rounded-2xl md:rounded-3xl shadow-xl aspect-square border-2 md:border-4 border-white bg-amber-100">
                <Image 
